...
<body>
    ...
    <div id="start-screen">
        ...
        <p style="color: gray; margin-top: 10px;">
            Teclas: <span id="display-teclas" style="color: white; font-weight: bold;">A - S - D - F</span>
        </p>
    ...
    <div id="game-interface">
        ...
        <div id="game-container">
            ...
            <div id="lane-a" class="lane">
                <div class="hit-zone"></div>
                <div class="key-label" id="label-lane-1">A</div> 
            </div>

            <div id="lane-s" class="lane">
                <div class="hit-zone"></div>
                <div class="key-label" id="label-lane-2">S</div>
            </div>

            <div id="lane-d" class="lane">
                <div class="hit-zone"></div>
                <div class="key-label" id="label-lane-3">D</div>
            </div>

            <div id="lane-f" class="lane">
                <div class="hit-zone"></div>
                <div class="key-label" id="label-lane-4">F</div>
            </div>
        </div>
    ...
    <div id="pause-menu">
        <div class="pause-content">
            ...
            <div style="margin: 20px 0; text-align: left;">
                <label for="pause-volume-slider" style="color: #aaa;">Volumen Maestro:</label><br>
                <input type="range" id="pause-volume-slider" min="0" max="1" step="0.1" value="1" style="width: 100%; cursor: pointer; margin-top: 10px;">
            </div>
    ...
    <button id="btn-settings" class="neon-btn-small">
        ⚙️ AJUSTES
    </button>
    <?php if(isset($_SESSION['rol']) && $_SESSION['rol'] == 1): ?>
    <button onclick="window.location.href='admin.php'" class="neon-btn-small" style="top: 70px; border-color: #00d2ff; color: #00d2ff; box-shadow: 0 0 10px rgba(0, 210, 255, 0.3);">
        🛡️ PANEL ADMIN
    </button>
    <?php endif; ?>
    <div id="settings-modal" style="display:none;"> 
        <div class="modal-content">
            ...
            <div style="margin: 20px;">
                <label>Volumen Maestro</label><br>
                <input type="range" id="settings-volume" min="0" max="1" step="0.1" value="1" style="width: 80%;">
            </div>
        
            <div style="margin: 20px;">
                <h3>Configurar Teclado</h3>
                <div style="display:flex; justify-content:center; gap:15px;">
                    <div>
                        <small style="color:#0f0">VERDE</small><br>
                        <input type="text" id="conf-key-a" readonly value="a" class="key-input">
                    </div>
                    <div>
                        <small style="color:#f00">ROJO</small><br>
                        <input type="text" id="conf-key-s" readonly value="s" class="key-input">
                    </div>
                    <div>
                        <small style="color:#ff0">AMARILLO</small><br>
                        <input type="text" id="conf-key-d" readonly value="d" class="key-input">
                    </div>
                    <div>
                        <small style="color:#00f">AZUL</small><br>
                        <input type="text" id="conf-key-f" readonly value="f" class="key-input">
                    </div>
                </div>
            </div>
        
            <div style="margin-top: 20px; color: #888; font-size: 0.9em;">
                <div id="gamepad-status">🎮 Conecta tu Mando</div>
            </div>
        
            <button id="btn-close-settings">GUARDAR Y SALIR</button>
        </div>
    </div>
